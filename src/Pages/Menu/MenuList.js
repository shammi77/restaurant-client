...
<section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
  ...
  <div class="card w-64 bg-base-100 shadow-2xl bg-primary m-20">
          <div class="card-body">
            ...
            <div class="card-actions ">
              <button class="btn btn-primary underline underline-offset-8 text-white">
                Explore
              </button>
            </div>
          </div>
  ...
  <div class="card w-64 bg-base-100 shadow-2xl bg-primary m-20">
          <div class="card-body">
            <h2 className="font-bold text-white">ミ★ 𝘚𝘜𝘎𝘌𝘙𝘌𝘕𝘊𝘐𝘈𝘚 𝘋𝘌𝘓 𝘊𝘏𝘌𝘍 / 𝘊𝘏𝘌𝘍'𝘚 𝘙𝘌𝘊𝘖𝘔𝘔𝘌𝘕𝘋𝘈𝘛𝘐𝘖𝘕𝘚𝘚 ★彡</h2>

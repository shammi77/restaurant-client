...
const MenuBiriani = () => {
    return (
        ...
        <h1 className="ml-56  italic text-amber-400">
          Segundo plato completo de arroz basmati, aromatizado con especias y combinado con carne, marisco o verdura a preferencia. Tambienincluyeuna salsa de verduras para acompanar./
        </h1>
        <p className="ml-56 italic text-white">Second full plate of basmati rice, flavored with spices and combined with meat, seafood or vegetables to preference. It also includes a vegetable sauce to accompany.</p>
        <br />

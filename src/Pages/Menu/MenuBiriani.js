    ...
    <div>
      <div className="bg-gradient-to-r from-gray-500 to-gray-800 m-20">
        ...
        <h1 className="p-4 lg:text-center italic text-amber-400">
          Segundo plato completo de arroz basmati, aromatizado con especias y
          combinado con carne, marisco o verdura a preferencia.
          Tambienincluyeuna salsa de verduras para acompanar./
        </h1>
        <h1 className="p-4 lg:text-center italic text-white">
          Second full plate of basmati rice, flavored with spices and combined
          with meat, seafood or vegetables to preference. It also includes a
          vegetable sauce to accompany.
        </h1>
        <br />

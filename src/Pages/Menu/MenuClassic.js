      ...
      <div className="bg-gradient-to-r from-gray-500 to-gray-800 mt-10">
        ...
        <div className="lg:text-center p-5">
          ...
          <p className=" italic text-amber-400">
            ...
            cilantro fresco, hierbas y especies. Ligeramente picante.{" "}
          </p>
          <h1 className="  text-white  text-xl">
          ...
          <p className=" italic text-amber-400">
            Cocinado con trozos de cebolla frito, cilantro y especias.
            Ligeramente picante.{" "}
          </p>
          <h1 className="  text-white  text-xl">
          ...
          <p className=" italic text-amber-400">
            Cocinado con especias y guindillas indios. Salsa extremadamente
            picante. Well spiced.
          </p>
          <h1 className="  text-white  text-xl">
          ...
          <p className=" italic text-amber-400">
            Cocinado con un trozo de patata y especias. Salsa extremadamente
            picante.{" "}
          </p>
          <h1 className="  text-white  text-xl">
